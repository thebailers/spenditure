...
// actions
import { addHousehold, addOnboardingStages, joinHousehold } from './action_creators'
...
class Onboarding extends Component {
  ...
  joinHousehold() {
    this.props
      .joinHousehold(this.state.householdUid, this.props.user._id)
      .then(
        res => console.log(res),
  ...
  render() {
    ...
    return (
      <div className="onboarding">
        ...
        <p>
          Are you joining an{' '}
          <button onClick={() => this.defineHousehold('existing')}>existing household</button>
          , or setting up a{' '}
          <button onClick={() => this.defineHousehold('new')}>new household</button>?
        </p>
        ...
        {createHousehold === 'existing' && (
          <div>
            ...
            <p>To join an existing household, enter the household code below.</p>

            {joinHouseholdError && (
              <div className="error">{this.state.errors.joinHouseholdError}</div>
            )}
            <input
              type="text"
